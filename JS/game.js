...
let prizes_config = {
    count:12,
    prize_names : ["3000 Credits", "35% Off","Hard Luck","70% OFF","Swagpack","100% OFF","Netflix","50% OFF","Amazon Voucher","2 Extra Spins","Swag Tshirt","Swag Book"]
}
...
function create() {
    ...
    //lets create a wheel
    this.wheel = this.add.sprite(W/2,H/2,"wheel"); //notice difference
                    // not (let wheel) but (this.wheel)
...
function update() {
    ...
    //this.wheel.angle += 1;  // for continious movement.
    //this.wheel.scaleX += 0.001;
    //this.wheel.scaleY += 0.001;
    //this.wheel.alpha -= 0.01; //will reduce the opacity of the object.
...
function spinwheel() {
    ...
    tween = this.tweens.add ({
        targets: this.wheel,
        angle: total_angle,  // randomly will have to generate
        //delay: 2000,
        ease : "Cubic.easeOut",
        duration: 6000,
        //scaleX : 0.5,
